...
export function BreachChecker() {
  ...
  // Clear the password when the component goes away, so navigating off the page
  // does not leave it in a retained React tree.
  useEffect(() => {
    return () => {
      setPassword("");
      setStatus(null);
  ...
  async function onSubmit(event: React.FormEvent) {
    ...
    // Ignore a response that a newer check has superseded.
